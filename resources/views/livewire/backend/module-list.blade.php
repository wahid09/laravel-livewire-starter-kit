            ...
            <div class="modal-body">
                    <div class="card-body">
                      ...
                      <div class="form-check">
                        <input type="checkbox" class="custom-control-input @error('is_active') is-invalid @enderror" id="is_active" wire:model.defer="is_active" @isset($user) {{ $role->is_active==true ? 'checked' : ''}} @endisset>
